...
public class BaseClient {
    ...
    private <T> ResponseEntity<Object> makeAndSendRequest(HttpMethod method, String path, Long userId,
        ...
        try {
            if (parameters != null) {
                if (body == null) {
                    log.info("Send to server: path - {}. method- {}, parameters - {}", path, method, parameters);
                } else {
                    log.info("Send to server: path - {}. method- {}, body - {}, parameters - {}",
                            path, method, body, parameters);
                }
                shareitServerResponse = rest.exchange(path, method, requestEntity, Object.class, parameters);
            } else {
                if (body == null) {
                    log.info("Send to server: path - {}. method- {}", path, method);
                } else {
                    log.info("Send to server: path - {}. method- {}, body - {}", path, method, body);
                }
